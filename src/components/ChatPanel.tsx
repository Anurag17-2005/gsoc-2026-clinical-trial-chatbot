      ...
      <div className="p-3 border-t border-border">
        <div className="flex gap-2">
          <input
            ...
            placeholder={userProfile ? "Ask about nearest or best trials..." : "Describe your condition..."}
        ...
        <div className="flex gap-2 mt-2 flex-wrap">
          {userProfile 
            ? ["Find nearest trials", "Best matches for me", "Explain eligibility", "Compare trials"].map((s) => (
              <button
                key={s}
                onClick={() => setInput(s)}
